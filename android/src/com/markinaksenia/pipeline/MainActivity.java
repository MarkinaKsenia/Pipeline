                ...
                if (dataSnapshot.child(user).exists())
                {
                    if(!user.isEmpty()){
                        ...
                        if (login.getPassword().equals(pwd)) {
                            ...
                            Toast.makeText(MainActivity.this, "Неверный пароль! Попробуйте еще раз", Toast.LENGTH_SHORT).show();
                    }
                    else {
                        Toast.makeText(MainActivity.this, "Пожалуйста, введите имя пользователя", Toast.LENGTH_SHORT).show();
                    }
                }
                else   Toast.makeText(MainActivity.this, "Такого пользователя не существует", Toast.LENGTH_SHORT).show();
            }
